...
function OnPlayerCommandText(playerid, cmdtext)
	...
	elseif cmdtext == "/enable" then
		EnableMarvin(playerid,1);
		SendPlayerMessage(playerid,255,0,0,"Marvin enabled");
		
	elseif cmdtext == "/disable" then
		EnableMarvin(playerid,0);
		SendPlayerMessage(playerid,0,255,0,"Marvin disabled");
