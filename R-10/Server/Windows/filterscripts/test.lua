...
function OnPlayerCommandText(playerid, cmdtext)
    ...
    elseif cmdtext == "/des" then
	SetServerDescription("Ouuu ju tacz maj tralalalalalalal");

    elseif cmdtext == "/gam" then
	SetGamemodeName("Panie, ta nazwa zostala zmieniona!");

   elseif cmdtext == "/host" then
	SetServerHostname("Zmienilim nazwe hosta, fuck yea!");
    end
end
